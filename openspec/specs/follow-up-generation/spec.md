...
Defines how the backend generates, stores, and returns follow-up questions alongside every assistant reply. Follow-up questions are produced in the same LLM call as the main reply and persisted in the database for retrieval.

...
## Purpose
Defines the frontend image attachment UX: file picker attachment, clipboard paste, staged image preview strip with dismiss, send button enablement rules, and state cleanup after send.

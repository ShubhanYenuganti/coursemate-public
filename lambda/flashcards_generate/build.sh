...
REPO_NAME="coursemate-flaschard-generate"
...
echo ""
echo "Next: attach SQS trigger to Lambda '${FUNCTION_NAME}' (queue: flaschard-generate)."
echo "Example:"
echo "  aws lambda create-event-source-mapping \\"
echo "    --function-name ${FUNCTION_NAME} \\"
echo "    --event-source-arn arn:aws:sqs:${AWS_REGION}:${AWS_ACCOUNT_ID}:flaschard-generate \\"
echo "    --batch-size 1 \\"
echo "    --enabled \\"
echo "    --region ${AWS_REGION}"
echo ""
echo "Remember to set API env var:"
echo "  FLASHCARDS_GENERATION_QUEUE_URL=https://sqs.${AWS_REGION}.amazonaws.com/${AWS_ACCOUNT_ID}/flaschard-generate"

...
REPO_NAME="coursemate-quiz-generate"
FUNCTION_NAME="quiz_generate"
IMAGE_TAG="latest"
...
echo ""
echo "Next: attach SQS trigger to Lambda '${FUNCTION_NAME}' (queue: quiz-generate)."
echo "Example:"
echo "  aws lambda create-event-source-mapping \\"
echo "    --function-name ${FUNCTION_NAME} \\"
echo "    --event-source-arn arn:aws:sqs:${AWS_REGION}:${AWS_ACCOUNT_ID}:quiz-generate \\"
echo "    --batch-size 1 \\"
echo "    --enabled \\"
echo "    --region ${AWS_REGION}"
echo ""
echo "Remember to set Vercel env var:"
echo "  QUIZ_GENERATION_QUEUE_URL=https://sqs.${AWS_REGION}.amazonaws.com/${AWS_ACCOUNT_ID}/quiz-generate"
